...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen text-white ">
      <LandingNavbar />
      <div className="max-w-4xl mx-auto p-6 mt-24 bg-dashboard">
        <h1 className="text-3xl font-bold mb-4 bg-gradient-to-r from-blue-600/40 to-purple-200 bg-clip-text text-transparent">
          Privacy Policy
        </h1>
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li className="mb-2">
              <strong>Application</strong> refers to Pace, the software program
              provided by the Company.
            </li>
            <li className="mb-2">
              <strong>Company</strong> (referred to as either "the Company",
              "We", "Us" or "Our" in this Agreement) refers to Pace.
            </li>
            <li className="mb-2">
